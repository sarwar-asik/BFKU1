...
import image1 from '../../Assctes/adminDashbordIcon/adminLogo.png'
...
const PasswordChangeAdmin = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 bg-gray-600 rounded p-5'>
           ...
           <img src={image1} alt="adminImag" className='w-8'/>
           <h3 className='text-center text-xl font-bold text-white mt-2 ml-2'>Admin Name</h3>
           </div>
            ...
            <form className='mt-3'>
                <input type="text" placeholder="Old password" className="input input-bordered w-full max-w-xs bg-gray-600 mb-3 border-green-300"/>
                <input type="text" placeholder="New password" className="input input-bordered w-full max-w-xs bg-gray-600 mb-3 border-green-300"/>
                <input type="text" placeholder="Confirm password" className="input input-bordered w-full max-w-xs bg-gray-600 border-green-300"/>
                <Link to='/passwordChange'> 
                <input type="submit" value='submit' className='btn bg-emerald-400 mt-3 w-full max-w-xs'/>
               </Link>
            </form>
        </div>
    );
